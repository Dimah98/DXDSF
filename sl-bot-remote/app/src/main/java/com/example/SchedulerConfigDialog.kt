...
import androidx.compose.ui.unit.sp // Одиниці виміру літер тексту
import androidx.compose.ui.window.Dialog // Системний контейнер діалогових вікон
import androidx.lifecycle.viewmodel.compose.viewModel // Функтор отримання ViewModel у Compose
...
fun SchedulerConfigDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Card(
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = 16.dp), // Поля згори та знизу
            shape = RoundedCornerShape(28.dp), // Сучасні округлі кути згідно гайдів
            colors = CardDefaults.cardColors(
                containerColor = Color(0xFF1C1F26) // Темний графітовий колір з Immersive UI
            ),
            border = BorderStroke(1.dp, Color.White.copy(alpha = 0.08f)), // Елегантна тонка сіра рамка
                ...
                Row(
                    ...
                    Column {
                        Text(
                            ...
                            color = Color(0xFF10B981), // Фірмовий ізумрудний колір
                ...
                if (isLoading) {
                    ...
                    Column(modifier = Modifier.fillMaxWidth()) {
                        ...
                        errorMessage?.let { error ->
                            Text(
                                text = error,
                                color = Color(0xFFEF4444), // Червоний колір для помилки
                                fontSize = 12.sp,
                                modifier = Modifier
                                    .fillMaxWidth()
                        ...
                        Row(
                            modifier = Modifier
                                ...
                                .background(Color(0xFF050505)) // Глибокий чорний фон підкладки
                            ...
                            Box(
                                modifier = Modifier
                                    ...
                                    .background(
                                        if (modeIntervalActive) Color(0xFF10B981) else Color.Transparent
                                    )
                                    .clickable {
                            ...
                            Box(
                                modifier = Modifier
                                    ...
                                    .clip(RoundedCornerShape(9.dp))
                                    .background(
                                        if (modeScheduleActive) Color(0xFF10B981) else Color.Transparent
                                    )
                                    .clickable {
                                        focusManager.clearFocus()
                                ...
                                Row(
                                    ...
                                    Box(
                                        modifier = Modifier
                                            ...
                                            .background(if (isMinutes) Color(0xFF10B981).copy(alpha = 0.15f) else Color.Transparent)
                                        ...
                                        Text(
                                            ...
                                            fontWeight = FontWeight.Bold,
                                            fontSize = 12.sp,
                                            color = if (isMinutes) Color(0xFF10B981) else Color.White.copy(alpha = 0.6f)
                                        )
                                    }
                                ...
                                daysOfWeek.forEach { (dayId, dayName) ->
                                    ...
                                    Box(
                                        modifier = Modifier
                                            ...
                                            .clip(CircleShape)
                                            .background(
                                                if (isSelected) Color(0xFF10B981) else Color(0xFF050505)
                                            )
                                            .border(
                                                BorderStroke(
                                                    1.dp,
